...
fig = make_subplots(rows=1, cols=2,subplot_titles=['Base stations on {}'.format(i) for i in deploy_tag])
...
fig.update_layout(title_text = "Instantaneous Graph Idleness for {}m_communication range".format(device_range),title_x=0.5)
fig.show()